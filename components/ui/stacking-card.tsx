  ...
  return (
    ...
    >
      <motion.div
        ...
        className={`flex flex-col relative -top-[10%] min-h-[550px] w-[90%] md:w-[70%] rounded-2xl p-8 md:p-12 origin-top shadow-2xl`}
      >
        ...
        <div className={`flex flex-col-reverse md:flex-row h-full mt-2 gap-8 md:gap-12`}>
          ...
          >
            ...
            >
              <img src={project.imageUrl || url} alt={title} className='absolute inset-0 w-full h-full object-cover' />
            </motion.div>
          </div>
        </div>
      </motion.div>
